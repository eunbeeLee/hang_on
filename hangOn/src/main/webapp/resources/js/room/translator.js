...
function Translator() {
    ...
    this.translateLanguage = function(text, config) {
        ...
        var source = 'https://www.googleapis.com/language/translate/v2?key=AIzaSyBioPgfLWVXr2oLCz7_wo_bfPHOP-E5vUw&target=' + (config.to || 'en-US') + '&callback=window.' + randomNumber + '&q=' + sourceText;
...
//      var url = 'https://www.googleapis.com/language/translate/v2/languages?key='+api_key+'&target=en';
        var url = 'https://www.googleapis.com/language/translate/v2/languages?key=AIzaSyBioPgfLWVXr2oLCz7_wo_bfPHOP-E5vUw&target=en';
